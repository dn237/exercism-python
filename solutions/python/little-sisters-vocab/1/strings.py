...
def make_word_groups(vocab_words):
    ...
    stop = len(vocab_words)
    str = ''
    
    for word in vocab_words[1:stop]:
        str += ' :: ' + prefix + word
    return prefix + str


#mylist = ['en', 'close', 'joy', 'lighten']
#mylist = ['pre', 'serve', 'dispose', 'position']
#print(make_word_groups(mylist))
