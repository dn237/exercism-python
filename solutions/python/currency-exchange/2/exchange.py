...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    plus_comission = ((spread/100)*exchange_rate) + exchange_rate

    #Total foreign currency you can afford (with decimals)
    total_new_currency = exchange_money(budget, plus_comission)

    #Use integer division (//) to find how many full bills you can get
    number_of_bills = get_number_of_bills(total_new_currency, denomination)

    #Multiply bills by denomination to get the final amount
