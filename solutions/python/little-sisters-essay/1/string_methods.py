...
#print(capitalize_title('hello my name is diana'))
...
print(check_sentence_ending('hello my name is diana'))
...
print(replace_word_choice('hey my name is diana', 'hey', 'hello'))